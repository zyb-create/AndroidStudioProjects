...
public class LrcViewSetting {
    ...
    public static final int NormalRowTextSize = 30;// in px
    public static final int HeightLightRowTextSize = 40;// in px
    public static final int TrySelectRowTextSize = 40;// in px
    public static final int MessagePaintTextSize = 27;// in px
    public int SelectLineTextSize = 27;// in px
    public int TimeTextSize = 27;// in px
    public int TriangleWidth = 0;// in px

    public static final int NormalRowColor =Color.parseColor("#FFE7BA"); //Color.WHITE;// 正常行字体颜色
    public static final int HeightRowColor = Color.parseColor("#FFFFFF");//Color.YELLOW;// 高亮行字体颜色
    public static final int TrySelectRowColor =Color.parseColor("#c0c0c0");// Color.GRAY;// 尝试选择行字体颜色
    public int MessageColor = Color.YELLOW;// 信息字体颜色
    public int SelectLineColor =Color.parseColor("#FFFFFF");// Color.GRAY;// 选择线颜色
    public int TimeTextColor = Color.parseColor("#FFFFFF");//Color.GRAY;// 选择线时间颜色
